...
public abstract class TygrysekDb extends BaseDb<TygrysekQueryStore> {
    ...
    public static class InteractiveQuery1 extends TygrysekListOperationHandler<LdbcQuery1, LdbcQuery1Result> {
        ...
        @Override
        public String getQueryString(TygrysekDbConnectionState state, LdbcQuery1 operation) {
        ...
        public LdbcQuery1Result convertSingleResult(Record record) throws ParseException {
            ...
            long friendBirthday = record.get(3).asLocalDate().atStartOfDay(ZoneId.of("GMT")).toInstant().toEpochMilli();
            long friendCreationDate = record.get(4).asZonedDateTime().toInstant().toEpochMilli();
    ...
    public static class InteractiveQuery2 extends TygrysekListOperationHandler<LdbcQuery2, LdbcQuery2Result> {
        ...
        @Override
        public String getQueryString(TygrysekDbConnectionState state, LdbcQuery2 operation) {
        ...
        public LdbcQuery2Result convertSingleResult(Record record) throws ParseException {
            ...
            long messageCreationDate = record.get(5).asZonedDateTime().toInstant().toEpochMilli();
    ...
    public static class InteractiveQuery3 extends TygrysekListOperationHandler<LdbcQuery3, LdbcQuery3Result> {
        ...
        @Override
        public String getQueryString(TygrysekDbConnectionState state, LdbcQuery3 operation) {
    ...
    public static class InteractiveQuery4 extends TygrysekListOperationHandler<LdbcQuery4, LdbcQuery4Result> {
        ...
        @Override
        public String getQueryString(TygrysekDbConnectionState state, LdbcQuery4 operation) {
    ...
    public static class InteractiveQuery5 extends TygrysekListOperationHandler<LdbcQuery5, LdbcQuery5Result> {
        ...
        @Override
        public String getQueryString(TygrysekDbConnectionState state, LdbcQuery5 operation) {
    ...
    public static class InteractiveQuery6 extends TygrysekListOperationHandler<LdbcQuery6, LdbcQuery6Result> {
        ...
        @Override
        public String getQueryString(TygrysekDbConnectionState state, LdbcQuery6 operation) {
    ...
    public static class InteractiveQuery7 extends TygrysekListOperationHandler<LdbcQuery7, LdbcQuery7Result> {
        ...
        @Override
        public String getQueryString(TygrysekDbConnectionState state, LdbcQuery7 operation) {
        ...
        public LdbcQuery7Result convertSingleResult(Record record) throws ParseException {
            ...
            String personFirstName = record.get(1).asString();
            String personLastName = record.get(2).asString();
            long likeCreationDate = record.get(3).asZonedDateTime().toInstant().toEpochMilli();
    ...
    public static class InteractiveQuery8 extends TygrysekListOperationHandler<LdbcQuery8, LdbcQuery8Result> {
        ...
        @Override
        public String getQueryString(TygrysekDbConnectionState state, LdbcQuery8 operation) {
        ...
        public LdbcQuery8Result convertSingleResult(Record record) throws ParseException {
            ...
            String personFirstName = record.get(1).asString();
            String personLastName = record.get(2).asString();
            long commentCreationDate = record.get(3).asZonedDateTime().toInstant().toEpochMilli();
    ...
    public static class InteractiveQuery9 extends TygrysekListOperationHandler<LdbcQuery9, LdbcQuery9Result> {
        ...
        @Override
        public String getQueryString(TygrysekDbConnectionState state, LdbcQuery9 operation) {
    ...
    public static class InteractiveQuery10 extends TygrysekListOperationHandler<LdbcQuery10, LdbcQuery10Result> {
        ...
        @Override
        public String getQueryString(TygrysekDbConnectionState state, LdbcQuery10 operation) {
    ...
    public static class InteractiveQuery11 extends TygrysekListOperationHandler<LdbcQuery11, LdbcQuery11Result> {
        ...
        @Override
        public String getQueryString(TygrysekDbConnectionState state, LdbcQuery11 operation) {
    ...
    public static class InteractiveQuery12 extends TygrysekListOperationHandler<LdbcQuery12, LdbcQuery12Result> {
        ...
        @Override
        public String getQueryString(TygrysekDbConnectionState state, LdbcQuery12 operation) {
    ...
    public static class InteractiveQuery14 extends TygrysekListOperationHandler<LdbcQuery14, LdbcQuery14Result> {
        ...
        @Override
        public String getQueryString(TygrysekDbConnectionState state, LdbcQuery14 operation) {
    ...
    public static class ShortQuery1PersonProfile extends TygrysekSingletonOperationHandler<LdbcShortQuery1PersonProfile, LdbcShortQuery1PersonProfileResult> {
        ...
        @Override
        public String getQueryString(TygrysekDbConnectionState state, LdbcShortQuery1PersonProfile operation) {
        ...
        public LdbcShortQuery1PersonProfileResult convertSingleResult(Record record) throws ParseException {
            ...
            long birthday = record.get(2).asLocalDate().atStartOfDay(ZoneId.of("GMT")).toInstant().toEpochMilli();
            ...
            long creationDate = record.get(7).asZonedDateTime().toInstant().toEpochMilli();
    ...
    public static class ShortQuery2PersonPosts extends TygrysekListOperationHandler<LdbcShortQuery2PersonPosts, LdbcShortQuery2PersonPostsResult> {
        ...
        @Override
        public String getQueryString(TygrysekDbConnectionState state, LdbcShortQuery2PersonPosts operation) {
        ...
        public LdbcShortQuery2PersonPostsResult convertSingleResult(Record record) throws ParseException {
            ...
            long messageCreationDate = record.get(2).asZonedDateTime().toInstant().toEpochMilli();
    ...
    public static class ShortQuery3PersonFriends extends TygrysekListOperationHandler<LdbcShortQuery3PersonFriends, LdbcShortQuery3PersonFriendsResult> {
        ...
        @Override
        public String getQueryString(TygrysekDbConnectionState state, LdbcShortQuery3PersonFriends operation) {
        ...
        public LdbcShortQuery3PersonFriendsResult convertSingleResult(Record record) throws ParseException {
            ...
            long friendshipCreationDate = record.get(3).asZonedDateTime().toInstant().toEpochMilli();
    ...
    public static class ShortQuery4MessageContent extends TygrysekSingletonOperationHandler<LdbcShortQuery4MessageContent, LdbcShortQuery4MessageContentResult> {
        ...
        @Override
        public String getQueryString(TygrysekDbConnectionState state, LdbcShortQuery4MessageContent operation) {
        ...
        public LdbcShortQuery4MessageContentResult convertSingleResult(Record record) throws ParseException {
            ...
            long messageCreationDate = record.get(0).asZonedDateTime().toInstant().toEpochMilli();
            String messageContent = record.get(1).asString();
    ...
    public static class ShortQuery5MessageCreator extends TygrysekSingletonOperationHandler<LdbcShortQuery5MessageCreator, LdbcShortQuery5MessageCreatorResult> {
        ...
        @Override
        public String getQueryString(TygrysekDbConnectionState state, LdbcShortQuery5MessageCreator operation) {
    ...
    public static class ShortQuery6MessageForum extends TygrysekSingletonOperationHandler<LdbcShortQuery6MessageForum, LdbcShortQuery6MessageForumResult> {
        ...
        @Override
        public String getQueryString(TygrysekDbConnectionState state, LdbcShortQuery6MessageForum operation) {
    ...
    public static class ShortQuery7MessageReplies extends TygrysekListOperationHandler<LdbcShortQuery7MessageReplies, LdbcShortQuery7MessageRepliesResult> {
        ...
        @Override
        public String getQueryString(TygrysekDbConnectionState state, LdbcShortQuery7MessageReplies operation) {
        ...
        public LdbcShortQuery7MessageRepliesResult convertSingleResult(Record record) throws ParseException {
            ...
            long commentCreationDate = record.get(2).asZonedDateTime().toInstant().toEpochMilli();
